...
namespace DoublyLinkedList
{
    class Node
    {
         ...
         *in terms of next adn previous nodes.*/
    ...
    class DoubleLinkedList
    {
        ...
        public void addNode()//Adds a new node
        {
                ...
                current.next)
            {
                ...
                {
                    Console.WriteLine("\nDuplicate roll numders not allowed");
                    return;
                }
            }
        ...
        public bool delNode(int rollNo)//Deleyes the specified node
        {
            Node previous, current;
        ...
        public void traverse()//Traverses the list
        {
            ...
            {
                Console.WriteLine("\nRecords in the ascending order of " + "rollnumbers are:\n");
                Node currentNode;
